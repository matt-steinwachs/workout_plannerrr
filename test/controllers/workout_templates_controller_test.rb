...
class WorkoutTemplatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create workout_template" do
    assert_difference('WorkoutTemplate.count') do
      post workout_templates_url, params: { workout_template: { cycle_template_id: @workout_template.cycle_template_id, name: @workout_template.name } }, as: :json
    end
  ...
  test "should update workout_template" do
    patch workout_template_url(@workout_template), params: { workout_template: { cycle_template_id: @workout_template.cycle_template_id, name: @workout_template.name } }, as: :json
    assert_response 200
  end
